...
class AzkarElsabahScreen extends StatelessWidget {
  ...
  final List<Zekaritem> azkar = [
    Zekaritem(text: 'اللّهـمَّ بك أصبحنا', repeat: 1),
    Zekaritem(text: 'أصبحنا وأصبح الملك لله', repeat: 3),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('أذكار الصباح'), centerTitle: true),
          ...
          return ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return Card(
                ...
                child: InkWell(
                  onTap: () {
                    context.read<AzkarCubit>().decrease(index);
                  },
                  child: Padding(
                    padding: const EdgeInsets.all(16),
                    child: Row(
